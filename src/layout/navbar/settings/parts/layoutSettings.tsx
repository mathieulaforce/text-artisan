...
const LayoutSettings: Component = () => {
  ...
  const layoutEntryClass =
    'flex gap-2 p-2 cursor-pointer bg-base-content hover:invert';
  ...
  return (
    <div class="flex flex-col gap-2">
      ...
      <div class="grid grid-cols-2 gap-2">
        <div
          class={`${layoutEntryClass} ${isSelectedLayoutClass(
            layout(),
            'rows',
          )}`}
        ...
        <div
          ...
          onclick={() => setLayout('result bottom')}
        >
        ...
        <div
          ...
          onclick={() => setLayout('result right')}
        >
